...
(function() {
  var Server, exports, parseAddr, path, pfs, run, setup, startSocketServer, startWebSocketServer, state, stateFd, usage;

  exports = module.exports = require('./base');

  startSocketServer = require('./socket').startSocketServer;
