...
(function() {
  var Server, exports, parseAddr, path, pfs, run, setup, startSocketServer, state, stateFd, usage;
  ...
  run = function() {
    ...
    return setup(function(s) {
      var args, host, i, name, port, socketAddr, webSocketAddr, xusServer, _ref, _ref1;
      socketAddr = null;
      webSocketAddr = null;
        ...
        while (i < args.length) {
          ...
          switch (args[i]) {
            ...
            case '-w':
              ...
              break;
            default:
              eval((_ref = args[i]) != null ? _ref : 'null');
          }
          i++;
        }
        if (webSocketAddr) {
          ...
          return startSocketServer(xusServer, host, port, function() {
