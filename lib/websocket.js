...
(function() {
  var CometConnection, Connection, ProxyMux, SocketConnection, WebSocketConnection, addDirHandler, addXusCometHandler, badPage, comet, contentType, createHandler, dirMap, exports, extensions, fs, nextHandler, path, send, url, urlHandlers, ws, _, _ref;

  exports = module.exports = require('./base');

  _ref = require('./transport'), ProxyMux = _ref.ProxyMux, SocketConnection = _ref.SocketConnection, WebSocketConnection = _ref.WebSocketConnection, Connection = _ref.Connection, CometConnection = _ref.CometConnection;
