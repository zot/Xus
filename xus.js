...
(function() {
  ...
  exports.BasicVarHandler = BasicVarHandler = (function() {

    function BasicVarHandler(storage) {
      if (storage) {
        this.__proto__ = storage;
      }
    }

    return BasicVarHandler;
  ...
  exports.Peer = Peer = (function() {
    ...
    Peer.prototype.processBatch = function(con, batch) {
      ...
      if (batch[0][0] === 'set' && batch[0][1] === 'this/name') {
        ...
        return this.processBatch(con, batch.slice(1));
      }
    };
